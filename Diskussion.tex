...
Från prov 3 ser vi inga klara trender för våra filters påverkan på $Q_i$ vid $\expval{n}=1$ eller $\expval{n}=10^4$ fotoner i resonatorn, vilket visas i tabell \ref{tab:Qi}. Vi ser heller inte några uppenbara trender i förlusttermen $1/Q_o$ med och utan filter i \figref{fig:Q_other_3}. Detta skulle kunna vara ett resultat av att våra korta filter, som är kopplade till detta prov, inte tillräckligt effektivt dämpar fotoner med en frekvens över \unit[88]{GHz}. Detta skulle i så fall innebära att även om fotonerna är reducerade i resonatorn så är detta inte tillräckligt för att reducera antalet kvasipartiklar till en sådan nivå att vi kan se en definitiv trend i $Q_i$ eller $1/Q_o$.
