...
Vi har anledning att tro att den termiska strålningen kan passera genom dessa bandpassfilter eftersom sådana alltid har ett begränsat stoppband \cite{santavicca2008}. Detta är ett problem eftersom strålning med tillräckligt hög energi kan bryta Cooperpar i en supraledare \cite{Gao2008}, i vårt fall för aluminium fotoner med $f>\unit[88]{GHz}$ eftersom aluminium har ett supraledande bandgap $\Delta E=\unit[0.36]{meV}$.

Strålningen kommer av alla övriga komponenter i kryostatens olika temperatursteg emitterar svartkroppsstrålning även vid temperaturer på bara några få milikelvin.
...
De högfrekventa fotonerna uppkommer inne i kyostaten, även efter att denna sköldats från omgivningen. Detta beror på att alla komponenter fortfarande uppvisar en liten bakgrundsstrålning, även vid låga temperaturer.

... (Jonathan har förklarat problemet i detalj som vi kommer skriva här, där kommer all specifik kvantifiering att presenteras, bl.a. temperaturer, energier, frekvenser osv.)
