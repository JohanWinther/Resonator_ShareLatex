...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Mätdata och resonatorn i \figref{fig:ex_magphs_resonator} i det komplexa planet. Observera att anpassningen även fungerar med få datapunkter nära resonansfrekvensen, vilket inte är uppenbart från \figref{fig:ex_magphs_resonator}.}
