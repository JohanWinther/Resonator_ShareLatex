...
\tikzfig{grafer/resonator_drift}{Intern kvalitetsfaktor $Q_i$ (övre) och resonansfrekvens (undre) för olika ineffekter i resonatorn. Vid effekter över \unit[-70]{dBm} driftar resonansfrekvensen iväg. Observera att ineffekten i resonatorn hänvisar till signalens styrka efter mätupställingens dämpning på \unit[67]{dBm}.}{fig:ex_res_drift}{0.8\columnwidth}{14em}
