...
Från \figref{fig:Q_other} kan vi se att för prov 1 och prov 2 verkar filter minska de förluster som inte är kopplade till TLS då förlusttermen $1/Q_o$ minskade för majoriteten av resonatorerna på prov 1 och 2. Resonatorerna uppvisade inge större förändringar i $1/Q_o$, men de små förändringar som fanns var av blandad karaktär.
