...
Vid tredje mätningen placerades en dämpning på totalt \unit[56]{dB} genom seriekopplade dämpare med dämpningar på 30,20 och \unit[6]{dB}. Detta gav data för effekter mellan \unit[-44]{dBm} och \unit[-83]{dBm}. För denna mätning krävdes många fler medelvärdesbildningar eftersom signalen var väldigt låg i relation till  bruset. Antal medelvärdesbildningar som behövdes vid varje effekt visas i en graf i \figref{fig:medel}.
