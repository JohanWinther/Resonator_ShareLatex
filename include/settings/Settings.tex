...
\titleformat{\chapter}[display]
  ...
  {{\fontsize{30pt}{1em}\vspace{-6.2ex}\selectfont \textnormal{\thechapter}}}{1ex}{}[]
...
\newcommand{\titel}{Lågpassfilter för minimering av kvasipartikelsgeneration i supraledande mikrovågsresonatorer}
\newcommand{\undertitel}{Preliminär utveckling av lågpassfilter för minimering av kvasipartikelrelaterade förluster från fotoner över \unit[100]{GHz}}
