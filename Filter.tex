...
\begin{wrapfigure}{r}{0.329\textwidth}
    \centering
...
\begin{figure}[H]
        ...
        \input{figure/grafer/Filters/attn_example_surf.tikz}
...
\begin{figure}[h]
    \centering
    \begin{tikzpicture}
        \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.75\textwidth]{figure/Filterbilder/filter_material.jpg}};
